...
INSERT INTO `blog_posts` VALUES (1,'Làm gì sau một cuộc thi Hackathon','Cách biến ý tưởng thành kết quả thực tế sau cuộc thi.','Nội dung chi tiết bài viết...','https://ui-avatars.com/api/?name=Blog+1&background=random','TAIKAI Team','for builders, ai & automation','2026-07-03 10:54:53',NULL),(2,'Giới thiệu Hackathon Management System','Nền tảng giúp bạn quản lý cuộc thi dễ dàng hơn.','Nội dung chi tiết bài viết 2...','https://ui-avatars.com/api/?name=Blog+2&background=random','Admin','product & partners','2026-07-03 10:54:53',NULL);
...
CREATE TABLE `chat_messages` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_EF20C9A6296CD8AE` (`team_id`),
  KEY `IDX_EF20C9A6A76ED395` (`user_id`),
  CONSTRAINT `FK_EF20C9A6296CD8AE` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_EF20C9A6A76ED395` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_messages` VALUES (1,'hello','2026-07-09 19:58:26',11,16),(2,'hi','2026-07-09 19:59:29',11,19);
...
CREATE TABLE `contest_problems` (
  ...
  `criteria_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `contests` (
  ...
  `status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UPCOMING',
  ...
  `prize_details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `team_join_requests` VALUES (1,1,9,NULL,'PENDING','2026-06-16 18:39:31'),(2,11,19,NULL,'APPROVED','2026-07-09 19:57:28');
...
INSERT INTO `teams` VALUES (1,'UEF','AI & ML','UE2383','APPROVED',5,4,NULL,NULL,NULL),(2,'BKU','AI & ML','BK1346','APPROVED',5,6,NULL,NULL,NULL),(3,'UIT','Web Development','UI6189','APPROVED',5,7,NULL,NULL,NULL),(4,'UTH2','AI & ML','UT3768','APPROVED',5,9,NULL,NULL,NULL),(5,'UTH3','AI & ML','UT3579','APPROVED',5,11,NULL,'/api/teams/images/team_avatar_5_1783670664.png','/api/teams/images/team_bg_5_1783670646.png'),(6,'Team Alpha','AI & ML','ALPHA123','active',5,1,NULL,NULL,NULL),(7,'Block Titans','Blockchain','TITAN123','active',5,1,NULL,NULL,NULL),(8,'Innovators','EdTech','INNOV123','active',5,1,NULL,NULL,NULL),(9,'Bạc Liêu','AI & ML','BẠ1989','APPROVED',5,14,NULL,NULL,NULL),(10,'Sóc Trăng','AI & ML','SÓ4839','APPROVED',5,15,NULL,NULL,NULL),(11,'Chung Sức','AI & ML','CH7607','APPROVED',5,16,NULL,NULL,NULL),(12,'huy','AI & ML','HU3862','APPROVED',5,17,'/api/teams/logo/team_12_1783074575.png',NULL,NULL);
...
-- Dump completed on 2026-07-10  9:22:51
