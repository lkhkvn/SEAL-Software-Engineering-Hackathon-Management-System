...
### Backend (Hệ thống xử lý & Cơ sở dữ liệu)
...
│   ├── config/               # Cấu hình Doctrine & Cơ sơ dữ liệu
...
Để chạy được dự án này trên máy tính của bạn, yêu cầu máy đã cài sẵn Docker và Node.js (v18 trở lên).

Bước 1: Khởi động Backend & Cơ sở dữ liệu (Docker)
Mở Terminal tại thư mục gốc của dự án (SEAL/).

Chạy lệnh dựng và khởi động các container:
...
Bash
npm run dev
Truy cập giao diện Web trên trình duyệt theo địa chỉ mặc định của Vite: http://localhost:5173/

🔑 Thông tin kết nối Cơ sở dữ liệu
Dành cho DBeaver / TablePlus / VS Code Database Client nếu bạn muốn kết nối trực tiếp từ phần mềm quản lý dữ liệu bên ngoài:
...
Tham số bổ sung (Extra Params - Bắt buộc cho MySQL 8.0): allowPublicKeyRetrieval=true&useSSL=false
